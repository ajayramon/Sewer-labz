...
<style>
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  .cover-photo-wrap { width:100%; max-width:680px; margin:0 auto; }
  .cover-photo { width:100%; height:400px; object-fit:cover; object-position:center; display:block; border-radius:3px; }
  .cover-no-photo { width:100%; height:400px; background:#f0f0f0; display:flex; align-items:center; justify-content:center; font-size:14px; color:#999; border-radius:3px; }
...
<!-- 3. DISCLOSURE + SCOPE + POINT OF REFERENCE -->
<div class="page">
  ${header(date, ref)}
...
<!-- 4. CLIENT & SITE INFO — address shown ONCE only -->
<div class="page">
  ${header(date, ref)}
  ...
  <div style="display:flex;gap:24px;align-items:flex-start;">
    ...
    <div style="flex-shrink:0;width:180px;">
      <img src="${photos[0]}" style="width:180px;height:135px;object-fit:cover;object-position:center;border:1px solid #ddd;border-radius:3px;display:block;" alt="Property" />
    </div>`
        : ""
    }
  </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-top:14px;">
    ${photos
      ...
      .map(
        (p) =>
          `<img src="${p}" style="width:100%;height:150px;object-fit:cover;object-position:center;border:1px solid #ddd;border-radius:3px;" />`,
      )
      .join("")}
  </div>`
      : ""
...
<!-- 11. COMMON SEWER DEFECT REFERENCE -->
<div class="page">
  ${header(date, ref)}
  ${defectTable}
